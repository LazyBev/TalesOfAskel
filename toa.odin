...
main :: proc() {
    ...
    for !WindowShouldClose() {
        ...
        if controlsVisible {
            DrawRectangle(5, 5, 250, 100, ColorAlpha(GRAY, 0.75));
            DrawRectangleLines(5, 5, 250, 100, BLACK);
            DrawText("Use W/S to navigate", 10, 10, 17, BLACK);
